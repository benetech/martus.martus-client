...
public class AccessTokenChangeHandler implements ChangeListener<String>
{
	public AccessTokenChangeHandler(TextField accessTokenFieldToUse, Button buttonToUse)
	{
		accessTokenField = accessTokenFieldToUse;
		buttonToChangeState = buttonToUse;
	}
	...
	private Button buttonToChangeState;
