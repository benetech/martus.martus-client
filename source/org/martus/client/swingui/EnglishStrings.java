...
"wintitle:RetrieveHQDraftBulletinSummaries=Retrieving Form Summaries",
"wintitle:AddPermissions=Update your contacts' access to Forms",
"wintitle:AddingPermissionsToBulletins=Update your Contacts' access to Forms",
...
"field:confirmClearHQInformationcause=You have chosen to remove the selected contact's accounts.  Any existing saved forms will still be visible by the old contact.  If you want to disallow this contact's viewing access to previously created Draft forms they must be re-saved after deleting the contact.  New versions of sealed forms will not be able to be viewed by the removed contact, but any old versions of sealed forms that already are on that contact's computer will still be viewable by the contact.",
"field:confirmClearHQInformationeffect=By clicking on Yes, any draft or sealed form saved in the future will no longer be accessible by your Contacts.",
"menu:ManageContacts=Manage Contacts",
"field:confirmAddingPermissionsToBulletinsCanceleffect=If you do this, the forms already processed will have the new headquarters access, but other selected forms will not.",
"field:confirmWarningSwitchToNormalKeyboardeffect=If you have been sent this form from one of your contacts, it is especially important to use the on-screen keyboard, because an attacker could gain access to all the private data that you are authorized to view.",
"field:confirmCloneBulletinAsMineeffect=Clicking on Yes will create a new form that contains a copy of all the same information. You will be the official author of this new form, and any private data in it will only be visible by you (and your Contact's accounts that you have shared the form with). The original form will remain unchanged.",
...
"field:BulletinHeadQuartersHQInfoForView=The following Contact account(s) can view the private information in this form, and can send this form to a server.",
...
"field:AddPermissionsOverview=This allows you to update your contacts' access to existing forms. " +
"Each of the forms in the list below will be modified to add the selected contacts' accounts. " +
"If a form is sealed, a new version will be created.",
"field:ChooseHeadquartersToAdd=Select the contacts listed below that you want to add to all the forms listed above.",
...
"field:statusNewFieldOfficeBulletins=New forms found on server",
"field:preferencesCheckFieldOfficeBulletins=Automatically check for new forms from Contacts",
