...
"wintitle:confirmBackupKeyPairMultiple=Backing Up Your Secret Share Files",
...
"field:confirmBackupKeyPairMultiplecause=We recommend that you now create #M# separate 'secret share' files of which any #N# can be used to reconstruct your keypair without a user name or password being required.",
"field:confirmBackupKeyPairMultipleeffect=By choosing Yes, you will be prompted to save pieces of your keypair onto removable disks.",
...
"field:BackupKeyShareCompleteInformation=Backup complete, please give each disk to someone you trust, so that if you forget your user name and or password in the future you can recreate your account.  You will need #N# of these secret share disks to recreate your account.",
