...
"wintitle:notifyCustomFieldSectionTooLarge=Custom Fields Error",
...
"field:PrintToPrinterOrDisk=You can print the bulletin contents to a printer, or send the formatted report to a file.",
"button:PrintToPrinter=Print to a printer",
"button:PrintToDisk=Send report to a file",
...
"field:notifyCustomFieldSectionTooLargecause=One of the custom field sections is larger than the maximum 64k size",
