...
"field:UserNameTips1=- Your user name can contain letters, numbers, punctuation and spaces.",
"field:UserNameTips2=- It should have between 8-50 characters, and it is case sensitive.",
"field:UserNameTips3=- Remember to choose a user name you can remember.",
"field:PasswordTips=Password Tips:",
"field:PasswordTipGeneral=Create secure passwords by using numbers, letters and symbols.",
"field:PasswordTips1=- Do not use your user name",
"field:PasswordTips2=- Do not use a single dictionary word",
"field:PasswordTips3=- Use at least 15 characters for most security (8 are required)",
"field:PasswordTips4=- Use a combination of alphabet characters, numbers, and special characters (such as !@#$%^*&amp;)",
"field:PasswordTips5=- Use a combination of uppercase (capital) and lowercase characters if you use a case-sensitive language.",
