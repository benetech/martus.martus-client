...
"field:confirmCloneMySealedAsDrafteffect=Clicking on Yes will create a new version of this bulletin that initially contains all the same information. In this release of Martus you will only be able to view the most current version.",
