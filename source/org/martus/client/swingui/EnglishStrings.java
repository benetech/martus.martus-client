...
"wintitle:notifyRecoveryProcessKeyShare=Restore Account from KeyShare",				
...
"wintitle:notifyRecoveryProcessBackupFile=Restore Keypair",
"wintitle:notifyRecoveryOfKeyPairComplete=Successful Restore of Keypair",
...
"wintitle:RecoverShareKeyPair=Restore from Share Disk",				
...
"wintitle:RecoverKeyPair=Restore Keypair from Backup File",
...
"button:RecoverAccountByBackup=Restore account from backup keypair file",
...
"field:RecoverAccount=Restore your existing account from floppy or a backup file.",
...
"field:BackupKeyPairToSecretShareInformation=This method breaks up your keypair into #M# 'secret share' pieces, any #N# of which will be required to reconstruct the keypair without requiring a password.  If you forget your login name or your password, this method is the only way you can restore your keypair.\n\nOnce the #M# files have been written to removable media disks, you should distribute them to #M# different people whom you will remember, but each of whom don’t know who you have given the other secret share files to.  Do not store any of the disks together.\n\nTo restore this keypair, first retrieve any #N# of the original #M# floppies (or other removable media disks), and then select 'Restore Account' and 'Restore account from multiple disks' when signing into Martus.\n",
...
"field:confirmRecoverUsingKeyShareeffect=Create a new account, or restore an old account from removable disks?",
...
"field:confirmRecoveredKeyShareFailedTryAgaincause=Restore of Keypair failed, we suggest you try again with a different set of files. Choose Yes to try again, No to exit Martus.",
...
"field:confirmUnableToRecoverFromBackupFilecause=Restore of Keypair failed, we suggest you try again with a different backup file. Choose Yes to try again, No to exit Martus.",
"field:confirmUnableToRecoverFromBackupFileeffect=Choosing Yes will begin the restore process again.",
...
"field:confirmBackupKeyPairInformationcause=Save your password encrypted keypair file to a single floppy disk or other removable media.  Then store this disk in a safe place. You will use this disk, with your username and password, to recover your data if your system files are ever damaged.  To restore this password-protected key pair in the future, select 'Restore Account' and 'Restore account from backup keypair file' when signing into Martus.",		
...
"field:notifyRecoveredKeyShareSucceededNewUserNamePasswordRequiredcause=Restore of keypair succeeded!  You now have to enter a user name and password.",
...
"field:notifyRecoveryProcessBackupFilecause=To restore your keypair file, first you must find the backup file you saved previously.  Using the 'Restore Key Pair from Backup File' dialog box find the file on your computer’s hard drive, a network drive, or removable media disk then click the Open button.  Martus will then ask you for your user name and password and restore your key pair so you can log in normally and access your account.",
"field:notifyRecoveryOfKeyPairCompletecause=Restore of your keypair file is complete, you will now be logged into Martus.",
"field:notifyErrorRecoveringAccountDirectorycause=Error during keypair restore. This keypair backup copy may be damaged.",
...
"field:QuickEraseWillRemoveItems=Delete your Martus keypair, bulletins, folders, and configuration information (such as your Headquarters, server, and custom field settings).",
"field:RemoveMartusWillUninstall=Uninstall the Martus program.",
"field:RemoveMartusWillRemoveAllOtherAccounts=Delete all other Martus accounts, including their keypair, folders, and bulletins.",
