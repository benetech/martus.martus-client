...
"field:AccessTokenNotSet=Access Token",
...
"field:CreateUser=Create an Account",
"field:CreateUserInstructions=When creating a user name and password for your account, please be aware there is no way to retrieve your user name and password if you forget it. This is for your safety.",
"field:CreateUserName=User Name:",
"field:UserNameInstructions=create a user name",
"field:Password=Password:",
...
"field:UserNameHints1=- Your user name can contain letters, numbers, punctuation and spaces.",
"field:UserNameHints2=- It should have between 8-50 characters, and it is case sensitive.",
"field:UserNameHints3=- Remember to choose a user name you can remember.",
"field:PasswordTips=Password Tips:",
"field:PasswordHints1=- Do not use your user name",
"field:PasswordHints2=- Do not use a single dictionary word",
"field:PasswordHints3=- Use at least 15 characters for most security (8 are required)",
"field:PasswordHints4=- Use a combination of alphabet characters, numbers, and special characters (such as !@#$%^*&amp;)",
"field:PasswordHints5=- Use a combination of uppercase (capital) and lowercase characters if you use a case-sensitive language.",
"field:ConfirmUserName=Confirm User Name",
